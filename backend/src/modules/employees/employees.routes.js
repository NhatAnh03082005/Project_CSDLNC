...
// });
router.get('/', authenticate, authorize(ROLES.ADMIN), employeeController.getAll);
...
// });
router.get('/:id', authenticate, authorize(ROLES.ADMIN), employeeController.getById);
...
// });
router.put('/:id', authenticate, authorize(ROLES.ADMIN), employeeController.update);
/**
...
// });
router.delete('/:id', authenticate, authorize(ROLES.ADMIN), employeeController.delete);
...
// });
router.post('/:id/transfer', authenticate, authorize(ROLES.ADMIN), employeeController.transfer);
/**
...
// });
router.put('/:id/salary', authenticate, authorize(ROLES.ADMIN), employeeController.updateSalary);
...
// });
router.get('/:id/transfer-history', authenticate, authorize(ROLES.ADMIN), employeeController.getTransferHistory);
...
// });
router.get('/doctors', authenticate, employeeController.getDoctors);
