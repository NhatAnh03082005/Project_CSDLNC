...
import { Heart, ArrowLeft, ShoppingBag, Loader2, Sparkles, Package, ArrowUpRight, Check, Search, Filter, Gift } from "lucide-react";
      ...
      <div className="bg-white border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 relative z-10 max-w-6xl">
          <div className="flex flex-col gap-6">
            <Link to="/branches?service=products" className="inline-flex items-center text-slate-500 hover:text-blue-600 font-bold text-sm transition-colors group w-fit">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-3">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
                  Danh sách <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-600">Sản phẩm</span>
                </h1>
              ...
              <div className="flex items-center gap-3">
                 <div className="p-4 bg-white rounded-2xl shadow-sm border border-slate-100 flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <p className="text-lg font-black text-slate-800 leading-none">{products.length} sản phẩm</p>
                    </div>
                 </div>
              </div>
            </div>
        ...
        {error ? (
          <div className="bg-white rounded-[2.5rem] border-2 border-dashed border-red-200 p-16 text-center shadow-sm">
            <div className="max-w-md mx-auto space-y-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-800 mb-2">Oops! Có lỗi xảy ra</h3>
          ...
          <div className="flex flex-col items-center justify-center py-32 space-y-4">
            ...
            <p className="text-slate-500 font-bold uppercase tracking-widest text-xs animate-pulse">Đang chuẩn bị sản phẩm...</p>
          </div>
        ) : products.length > 0 ? (
            ...
            {products.map((product) => {
              ...
              return (
                <div 
                  ...
                  className="group relative bg-white rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-orange-100/30 transition-all duration-500 overflow-hidden flex flex-col cursor-pointer"
                >
                  ...
                  <div className="h-48 relative overflow-hidden">
                     ...
                     />
                     <div className={`absolute inset-0 bg-gradient-to-t ${theme} opacity-60`} />
                  ...
                  <div className="p-8 pt-10 flex-1 flex flex-col relative">
                    <div className="absolute top-0 left-8 -translate-y-1/2">
                       <Badge className={`${typeColor} border-none rounded-lg px-3 py-1 font-black text-[10px] uppercase tracking-widest shadow-sm`}>
                          {typeName}
                       </Badge>
                    </div>
                    ...
                    <div className="flex items-center gap-2 mb-6">
                       <div className={`h-2 w-2 rounded-full ${product.soLuongTonKho > 0 ? 'bg-emerald-500 animate-pulse' : 'bg-red-500'}`} />
                       <span className="text-xs font-bold text-slate-400 tracking-wide uppercase">
                         {product.soLuongTonKho > 0 ? `Còn ${product.soLuongTonKho} sản phẩm` : "Hết hàng"}
                       </span>
                    </div>

                    <div className="mt-auto flex items-end justify-between gap-4 pt-6 border-t border-slate-50">
                      <div className="space-y-1">
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Giá bán</span>
          ...
          <div className="bg-white rounded-[3rem] border-2 border-dashed border-slate-200 p-20 text-center shadow-sm max-w-4xl mx-auto overflow-hidden relative">
            <div className="max-w-md mx-auto space-y-8 relative z-10">
              ...
              <div className="space-y-3">
                <h3 className="text-3xl font-black text-slate-900 tracking-tight">Trống trải quá!</h3>
                <p className="text-slate-500 text-lg font-medium leading-relaxed">
                  Hiện chưa có sản phẩm nào được bày bán tại chi nhánh này. Bạn vui lòng quay lại sau hoặc chọn chi nhánh khác nhé.
                </p>
              </div>
