...
import { Activity, TrendingUp, TrendingDown, Syringe } from "lucide-react";
import AdminHeader from "../../components/AdminHeader";
import { reportAPI } from "../../../../api/services";

export default function VaccineStats() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await reportAPI.getVaccines(params);
                ...
                <CardHeader>
                  <div className="pr-8">
                    <h3 className="text-lg font-bold text-sky-600">
                      {branch.TenChiNhanh[0] || "Chi nhánh"}
                    </h3>
                    <span className="inline-block px-3 py-1 text-xs font-medium bg-blue-100 text-blue-700 rounded-full">
                      {branch.MaChiNhanh || "N/A"}
                    </span>
                  </div>
                </CardHeader>
