    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Tra cứu thuốc</h1>
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <p className="text-gray-600 text-lg">Không tìm thấy thuốc nào</p>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-900">{selectedMedicine.maSanPham}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Loại
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge
                    className={getStockStatus(selectedMedicine.soLuong).color}
                  >
