    ...
    return (
      <div className="flex flex-col gap-3 bg-slate-50/50 p-4 rounded-[1.5rem] border border-slate-100 transition-all hover:bg-white hover:shadow-md hover:shadow-orange-100/30">
        <div className="flex items-center justify-between px-1">
          <Label className="text-[10px] font-black uppercase text-slate-500 tracking-widest shrink-0">
            {label}
          </Label>
          ...
          {loading ? (
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-medium">
                    Đặt lịch khám hoặc tiêm phòng để trải nghiệm dịch vụ của
                    chúng tôi
                  </p>
                </div>
                <Button
            ...
            <div className="grid gap-8">
              {services.map((service) => (
                <Card
                  key={`${service.MaHoaDon}-${service.STT}`}
                  className={`rounded-[2.5rem] border-slate-100 bg-white/80 backdrop-blur-xl shadow-xl shadow-slate-200/40 transition-all duration-500 border-2 overflow-hidden group ${
                  ...
                  <CardContent className="p-8">
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="flex items-center gap-4 mb-6 flex-wrap">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <Badge
                                variant="secondary"
                                className="bg-slate-100 text-slate-600 font-bold text-[10px] uppercase tracking-wider rounded-lg px-2 py-0.5"
                              >
                          ...
                          <div className="flex items-center gap-3 group/item">
                            ...
                            <div>
                              ...
                              <div className="text-sm font-black text-orange-600">
                                {service.ThanhTien?.toLocaleString("vi-VN")}{" "}
                                <span className="text-xs uppercase ml-0.5">
                                  vnđ
                                </span>
                              </div>
                            </div>
                          ...
                          <div className="mt-8 p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100/50 backdrop-blur-sm relative overflow-hidden group/review hover:bg-white transition-all duration-500">
                            ...
                            <div className="space-y-4 relative z-10">
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-3 border-b border-slate-100">
                                ...
                                <ScoreDisplay
                                  value={service.DanhGia.DiemChatLuongDV}
                                />
                              </div>
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-3 border-b border-slate-100">
                                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">
                                ...
                                <ScoreDisplay
                                  value={service.DanhGia.DiemThaiDoNV}
                                />
                              </div>
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-3">
                                ...
                                <ScoreDisplay
                                  value={service.DanhGia.DiemTongThe}
                                />
                              </div>
                      ...
                      <div className="flex flex-col sm:flex-row lg:flex-col gap-3 min-w-[180px]">
                        <Button
                          variant="premium"
                          className={`flex-1 h-14 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl transition-all active:scale-[0.98] ${
                            service.DaDanhGia
                              ? "bg-white text-slate-900 border border-slate-100 hover:bg-slate-50 shadow-slate-200"
                              : "bg-gradient-to-r from-orange-600 to-amber-600 text-white shadow-orange-200 hover:shadow-orange-400 border-none"
                          }`}
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-2xl rounded-[3rem] p-0 overflow-hidden border-none shadow-2xl">
          ...
          <DialogFooter className="p-8 pt-0 flex gap-3">
            <Button
              variant="outline"
              className="h-14 rounded-2xl flex-1 font-black uppercase text-xs tracking-widest border-2 border-slate-100 text-slate-500"
