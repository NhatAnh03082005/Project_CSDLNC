...
import { Home, Calendar, FileText, Receipt, Users, User, LogOut } from 'lucide-react';
...
const EmployeeLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Lịch hẹn', href: '/employee/schedule', icon: Calendar },
    { name: 'Hồ sơ khám', href: '/employee/medical', icon: FileText },
    { name: 'Lập hóa đơn', href: '/employee/invoice', icon: Receipt },
  ];
